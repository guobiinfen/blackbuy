    ...
    export default {
        ...
        created() {
            axios.get('http://111.230.232.110:8899/site/goods/gettopdata/goods').then(Response => {
                ...
                this.catelist = Response.data.message.toplist;
            })
...
axios.get('http://111.230.232.110:8899/site/goods/gettopdata/goods').then(Response => { console.log(Response); this. catelist=Response.data.message.catelist;